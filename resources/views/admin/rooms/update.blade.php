    ...
    <div class="content-wrapper">
        ...
        <div class="row d-flex aling-items-center justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Update Room Form</h4>
                        <form method="POST" action="{{ route('admin.room.update',['id'=>$room->id]) }}" enctype="multipart/form-data"
                            class="forms-sample">
                            @csrf
                                ...
                                <div class="col-sm-9">
                                    <select name="room_category_id" id="" class="form-control">
                                        ...
                                        @foreach ($room_categorys as $category)
                                            <option @selected($category->id == $room->room_category_id) value="{{ $category->id }}">{{ $category->name }}</option>
                                        @endforeach
                                    </select>
